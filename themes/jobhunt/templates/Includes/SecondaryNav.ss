    ...
    <nav class="navbar navbar-expand-md container justify-content-end">
        ...
        <div class="collapse navbar-collapse justify-content-end px-4 px-lg-5" id="secondaryNav">
            <ul class="navbar-nav mb-2 mb-lg-0">
                <li class="nav-itemd">
                    <a class="nav-link $LinkingMode <% if $URLSegment == "home" %>active<% end_if %>" rel="nofollow"
                       href="/">Dashboard</a>
                </li>
                <% loop $SecondaryNav %>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu border-0 show dropdown-menu-end py-0 bg-transparent"
                ...
                <li class="nav-item $FirstLast $EvenOdd">
                    <a class="h4 ps-2 m-0" rel="nofollow" href="$LogoutURL" title="Logout"
                       aria-description="Logout button">
