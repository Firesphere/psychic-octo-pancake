...
/* harmony import */ var _src_fav__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/fav */ "./client/javascript/src/fav.js");
/* harmony import */ var _src_body__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/body */ "./client/javascript/src/body.js");
/* harmony import */ var _src_tags__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/tags */ "./client/javascript/src/tags.js");
/* harmony import */ var _src_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./src/forms */ "./client/javascript/src/forms.js");
/* harmony import */ var _src_moods__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./src/moods */ "./client/javascript/src/moods.js");
/* harmony import */ var _src_filter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./src/filter */ "./client/javascript/src/filter.js");
/* harmony import */ var _src_profile__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./src/profile */ "./client/javascript/src/profile.js");
...
(0,_src_fav__WEBPACK_IMPORTED_MODULE_1__["default"])();
(0,_src_tags__WEBPACK_IMPORTED_MODULE_3__["default"])();
(0,_src_body__WEBPACK_IMPORTED_MODULE_2__["default"])();
(0,_src_forms__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_src_moods__WEBPACK_IMPORTED_MODULE_5__["default"])();
(0,_src_filter__WEBPACK_IMPORTED_MODULE_6__["default"])();
(0,_src_profile__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var favs = Array.from(document.getElementsByClassName('js-fav'));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  favs.forEach(function (fav) {
    fav.addEventListener('click', function (event) {
      event.preventDefault();
      var icon = fav.children[0];
      var add = false;
      icon.classList.toggle('text-warning');
      icon.classList.toggle('bi-star-fill');
      icon.classList.toggle('bi-star');
      fetch("fav/addremove/".concat(fav.getAttribute('data-id')));
    });
  });
});
...
/***/ "./client/javascript/src/filter.js":
/*!*****************************************!*\
  !*** ./client/javascript/src/filter.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var filters = [document.getElementById('show_rolefilter'), document.getElementById('show_companyfilter')];
var filterInputs = [document.getElementById('rolefilter'), document.getElementById('companyfilter')];
var filterclears = [document.getElementById('clear_companyfilter'), document.getElementById('clear_rolefilter')];
var tablebody = document.getElementById('applicationtable_body');
var timer;
var searchResult = function searchResult(field) {
  var searchValue = field.value;
  var searchType = field.getAttribute('id');
  ...
  fetch('/applicationfilter', {
    ...
    Array.from(document.getElementsByClassName('pagination')).forEach(function (paginator) {
      paginator.remove();
    });
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  if (filterclears.length > 0 && filterclears[0]) {
    filterclears.forEach(function (clearer) {
      clearer.addEventListener('click', function (e) {
        e.preventDefault();
        var elmId = clearer.getAttribute('id').split('_');
  ...
  if (filters.length > 0 && filters[0]) {
    filters.forEach(function (element) {
      element.addEventListener('click', function (event) {
        event.preventDefault();
        var elmId = element.getAttribute('id').split('_');
        document.getElementById("".concat(elmId[1], "_group")).classList.toggle('d-none');
  ...
  if (filterInputs.length > 0 && filterInputs[0]) {
    filterInputs.forEach(function (field) {
      field.addEventListener('keyup', function () {
        ...
        tablebody.innerHTML = '';
        tablebody.insertAdjacentHTML('beforeend', '<tr><td colspan="100" class="text-center p-3">\n' + '  <div class="spinner-border" role="status">\n' + '    <span class="visually-hidden">Loading...</span>\n' + '  </div>\n' + '</td></tr>');
        if (field.value !== '') {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _formhooks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./formhooks */ "./client/javascript/src/formhooks.js");
var actions = Array.from(document.getElementsByClassName('js-formaction'));
var formcontainer = document.getElementById('formcontainer');
var myModalEl = document.getElementById('addItemModal');
var actionTypeSpan = document.getElementById('modal-item-type');
var actionTitleSpan = document.getElementById('modal-item-title');
...
var typemap = {
  ...
  'close': ['CloseForm', 'close application']
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  bindActions(actions);
  myModalEl.addEventListener('hidden.bs.modal', function (event) {
    (0,_formhooks__WEBPACK_IMPORTED_MODULE_0__.updateFormContent)();
  });
  myModalEl.addEventListener('shown.bs.modal', function (event) {
    var cardlist = Array.from(document.getElementsByClassName('js-formaction card-link'));
    bindActions(cardlist);
  });
});
var bindActions = function bindActions(list) {
  list.forEach(function (action) {
    action.addEventListener('click', function (e) {
      e.preventDefault();
      var type = action.getAttribute('data-itemtype').split('-');
      var url = "".concat(endpoint).concat(typemap[type[0]][0]);
      var id = 0;
      if (type.length > 1) {
        if (type[1] === 'add') {
      ...
      fetch(url, {
        ...
        if (response['success'] && response['form'] !== false) {
          ...
          (0,_formhooks__WEBPACK_IMPORTED_MODULE_0__.addFormHook)();
        } else {
          (0,_formhooks__WEBPACK_IMPORTED_MODULE_0__.updateFormContent)();
          setTimeout(function () {
            window.location.reload();
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var tagFields = Array.from(document.getElementsByTagName('bs-tags'));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
...
/******/ 	__webpack_require__.O(undefined, ["dist/css/main","dist/css/calendar"], () => (__webpack_require__("./client/javascript/main.js")))
/******/ 	__webpack_require__.O(undefined, ["dist/css/main","dist/css/calendar"], () => (__webpack_require__("./client/scss/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/css/main","dist/css/calendar"], () => (__webpack_require__("./client/scss/calendar.scss")))
