...
/* harmony import */ var chartjs_chart_sankey__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! chartjs-chart-sankey */ "./node_modules/chartjs-chart-sankey/dist/chartjs-chart-sankey.esm.js");


var moodchart = document.getElementById('moodchart');
var sankeychart = document.getElementById('sankeychart');
var applicationchart = document.getElementById('applicationchart');
var moods = ['😖', '️☹️', '😐', '🙂', '😃'];
...
URL = URL.slice(-1) === '/' ? "".concat(URL, "home") : URL;
var moodOptions = {
  type: 'line',
  data: {
    labels: [],
      ...
      y: {
        ...
        ticks: {
          callback: function callback(value, index, ticks) {
            var _moods;
            return (_moods = moods[value - 1]) !== null && _moods !== void 0 ? _moods : '';
          },
          font: {
            size: 25
          }
...
var sankeyOptions = {
  ...
  data: {
    datasets: [{
      label: 'My sankey',
      data: [],
      colorFrom: function colorFrom(c) {
        return getColor(c.dataset.data[c.dataIndex].from);
      },
      colorTo: function colorTo(c) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  if (moodchart) {
    var _moodchart$getAttribu;
    var attr = (_moodchart$getAttribu = moodchart.getAttribute('data-name')) !== null && _moodchart$getAttribu !== void 0 ? _moodchart$getAttribu : 'getChartData';
    var endpoint = "".concat(URL, "/").concat(attr);
    fetch(endpoint, {
      method: 'GET',
      headers: {
      ...
      new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Chart(moodchart, moodOptions);
    });
  }
  if (sankeychart) {
    var _sankeychart$getAttri;
    var _attr = (_sankeychart$getAttri = sankeychart.getAttribute('data-name')) !== null && _sankeychart$getAttri !== void 0 ? _sankeychart$getAttri : 'getChartData';
    var _endpoint = "".concat(URL, "/").concat(_attr);
    chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Chart.register(chartjs_chart_sankey__WEBPACK_IMPORTED_MODULE_1__.SankeyController, chartjs_chart_sankey__WEBPACK_IMPORTED_MODULE_1__.Flow);
    fetch(_endpoint, {
      method: 'GET',
      headers: {
        "x-requested-with": "XMLHttpRequest"
      ...
      new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Chart(sankeychart, sankeyOptions);
    });
  }
  if (applicationchart) {
    var _applicationchart$get;
    var _attr2 = (_applicationchart$get = applicationchart.getAttribute('data-name')) !== null && _applicationchart$get !== void 0 ? _applicationchart$get : 'getOtherCharts';
    var _endpoint2 = "".concat(URL, "/").concat(_attr2);
    fetch(_endpoint2, {
      method: 'GET',
      headers: {
        'x-requested-with': 'XMLHttpRequest'
      ...
      new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__.Chart(applicationchart, barOptions);
    });
  }
});
...
/* harmony export */   SankeyController: () => (/* binding */ SankeyController)
/* harmony export */ });
...
function toTextLines(raw) {
  const lines = [];
  const inputs = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.isArray)(raw) ? raw : (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndef)(raw) ? [] : [raw];
...
class SankeyController extends chart_js__WEBPACK_IMPORTED_MODULE_1__.DatasetController {
  /**
  ...
  updateElements(elems, start, count, mode) {
    ...
    const borderWidth = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.valueOrDefault)(dataset.borderWidth, 1) / 2 + 0.5;
    const nodeWidth = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.valueOrDefault)(dataset.nodeWidth, 10);
  ...
  _drawLabels() {
    ...
    const borderWidth = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.valueOrDefault)(dataset.borderWidth, 1);
    const nodeWidth = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.valueOrDefault)(dataset.nodeWidth, 10);
  ...
  _drawLabel(label, y, height, ctx, textX) {
    const font = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.toFont)(this.options.font, this.chart.options.font);
    const lines = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.isNullOrUndef)(label) ? [] : toTextLines(label);
    const linesLength = lines.length;
    const middle = y + height / 2;
    const textHeight = font.lineHeight;
    const padding = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.valueOrDefault)(this.options.padding, textHeight / 2);
...
function setStyle(ctx, {x, x2, options}) {
  ...
  if (options.colorMode === 'from') {
    fill = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.color)(options.colorFrom).alpha(0.5).rgbString();
  } else if (options.colorMode === 'to') {
    fill = (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.color)(options.colorTo).alpha(0.5).rgbString();
  } else {
    fill = ctx.createLinearGradient(x, 0, x2, 0);
    fill.addColorStop(0, (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.color)(options.colorFrom).alpha(0.5).rgbString());
    fill.addColorStop(1, (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.color)(options.colorTo).alpha(0.5).rgbString());
  }
...
class Flow extends chart_js__WEBPACK_IMPORTED_MODULE_1__.Element {
...
Flow.defaults = {
  ...
  colorTo: 'green',
  colorMode: 'gradient',
  hoverColorFrom: (ctx, options) => (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.getHoverColor)(options.colorFrom),
  hoverColorTo: (ctx, options) => (0,chart_js_helpers__WEBPACK_IMPORTED_MODULE_0__.getHoverColor)(options.colorTo)
};
...
(() => {
/*!*************************************!*\
  !*** ./client/javascript/charts.js ***!
  \*************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _src_charts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/charts */ "./client/javascript/src/charts.js");

(0,_src_charts__WEBPACK_IMPORTED_MODULE_0__["default"])();
})();
